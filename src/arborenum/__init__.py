...
def _parse_model_reliance(model_reliance):
    key = _normalize_key(model_reliance)
    ...
    raise ValueError(
        "model_reliance must be 'subtractive' or 'divisive'."
    )
...
class ArborEnum:
    ...
    def get_exact_replacement_divisive_importance_intervals(
        self,
        X_eval,
        y_eval,
        budget_override=None,
    ...
    def compute_rid(
        ...
        *,
        ...
        divisive_model_reliance = _parse_model_reliance(
            model_reliance
        )
        ...
        if divisive_model_reliance and importance_interval_mode != 1:
            raise ValueError(
                "model_reliance='divisive' requires "
